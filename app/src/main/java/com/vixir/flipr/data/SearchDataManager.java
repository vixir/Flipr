...
public abstract class SearchDataManager extends BaseDataManager<List<? extends PhotoShot>> {
    ...
    public void loadDataSource(int page, String query) {
        this.query = query;
        loadStarted();
    /*
     ...
     */
        final Call<PhotoPage> topPics = getFliprApi().getPhotosFeed(BuildConfig.FLICKR_API_KEY, query, page + "");
