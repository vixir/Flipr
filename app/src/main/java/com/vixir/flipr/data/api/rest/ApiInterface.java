...
public interface ApiInterface {
    ...
    @GET("rest/?method=flickr.photos.search&format=json&nojsoncallback=1&group_id=2297498%40N20")
    Call<PhotoPage> getPhotosFeed(@Query("api_key") String apiKey, @Query("tags") String tags, @Query("per_page") String count);
